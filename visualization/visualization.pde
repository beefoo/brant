...
void setup() {  
  ...
  font = createFont("OpenSans-Semibold", fontSize, true);
  scaleFont = createFont("OpenSans-Regular", scaleFontSize, true);
  statusFont = createFont("OpenSans-Regular", statusFontSize, true);
